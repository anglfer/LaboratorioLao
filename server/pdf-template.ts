  ...
  return `
    ...
    <body>
        ...
        <div class="header">
            ...
            <div class="company-subtitle">Laboratorio de Ensayo Acreditado por EMA</div>
        ...
        <div class="info-section">
            ...
            <div class="info-box">
                ...
                <div class="info-item">
                    ...
                    <span class="info-value">30 días naturales</span>
                </div>
            </div>
        </div>
        ...
        <div class="signature-section">
            ...
            <div class="signature-boxes">
                <div class="signature-box">
                    <div style="font-weight: bold; margin-bottom: 15px;">LABORATORIO Y CONSULTORÍA LOA</div>
                    <div class="signature-line"></div>
                    <div class="signature-label">Nombre y Firma del Representante</div>
                    <div style="margin-top: 8px; font-size: 9px;">Fecha: _______________</div>
                </div>
                <div class="signature-box">
                    <div style="font-weight: bold; margin-bottom: 15px;">CLIENTE</div>
                    <div class="signature-line"></div>
                    <div class="signature-label">Nombre y Firma del Cliente</div>
                    <div style="margin-top: 8px; font-size: 9px;">Fecha: _______________</div>
                </div>
            </div>
        </div>
        ...
        <div class="terms-section">
            ...
            <div class="terms-content">
                ...
                <p><strong>* Vigencia:</strong> Este presupuesto tiene una vigencia de 30 días naturales a partir de la fecha de emisión.</p>
